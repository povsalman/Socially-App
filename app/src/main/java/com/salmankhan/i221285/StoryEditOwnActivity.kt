...
class StoryEditOwnActivity : AppCompatActivity() {
    ...
    private fun saveStoryToFirebase() {
        lifecycleScope.launch {
            try {
                ...
                try {
                    ...
                    Log.e("StoryEditOwnActivity", "Error getting user profile: ${e.message}", e)
                    Toast.makeText(this@StoryEditOwnActivity, "Error getting user info: ${e.message}", Toast.LENGTH_LONG).show()
                }
